...
<?php
	...
	$password_hash = "$2y$10\$qC6oaV47ZXvRLqMkBK0PKOCZHipgH9CaqV0F/FSDImDV6EEXwGX7a";

	//if (!password_verify($password, $password_hash)) header('Location: login.php');
...
<div id="explorer" class="explorer window outset">
